...
# Knơledge
one - one relationship eager fetch
https://stackjava.com/hibernate/hibernate-fetchtype-la-gi-phan-biet-fetchtype-lazy-voi-eager.html

transaction begin create persistence context 
transaction end detroy persistence context
persistence context tracking entities 
each method of entitymanager have a transaction
